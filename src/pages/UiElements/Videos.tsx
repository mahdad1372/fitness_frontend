...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Fitness - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Fitness - React.js Tailwind CSS Admin Dashboard Template"
      />
